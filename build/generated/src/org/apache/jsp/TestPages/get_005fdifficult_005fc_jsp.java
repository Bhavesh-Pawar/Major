...
public final class get_005fdifficult_005fc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String sql ="select * from answer where id>=21 and id<=30";
count=0;
int i=21;
...
out.println(e);
      ...
      out.print( count );
      out.write("</h2>\n");
      out.write("<a href=\"../CorrectAnswers/C_difficult.jsp\" >Click me to get Correct answers</a>\n");
      out.write("</body>\n");
      out.write("</html>");
    } catch (Throwable t) {
